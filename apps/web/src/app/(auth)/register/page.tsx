...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      console.log('🔄 Начинаем регистрацию...', { email, fullName })
      ...
      if (error) {
        ...
        if (data.user.email_confirmed_at) {
          ...
          setSuccess('Регистрация прошла успешно! Проверьте почту для подтверждения email, затем войдите в систему.')
        }
      } else {
        console.warn('⚠️ Неожиданный результат:', { data, error })
